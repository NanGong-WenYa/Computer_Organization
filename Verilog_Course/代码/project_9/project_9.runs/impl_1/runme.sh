...
HD_PWD='C:/Users/Lenovo/project_9/project_9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_32bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult_32bit.tcl -notrace
