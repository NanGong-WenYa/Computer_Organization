...
HD_PWD='C:/Users/Lenovo/project_9/project_9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_32bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_32bit.tcl
