...
HD_PWD='C:/Users/Lenovo/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add16.tcl -notrace
